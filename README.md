...
9. Теперь вам нужно выбрать, какие отношения группировок загрузить:
   ...
   9.2. Отношения группировок из ранее сделанного сохранения, когда они работали правильно:
      ...
      9.2.7. Найдите **имя слота того сохранения**, который вы запомнили, внутри файла `saveinfo.xml` по пути сохранения `saves/номер_сохранения/saveinfo.xml`. Запомните путь `saves/номер_сохранения/`;
...
```lua
GS:LoadToleranceStatus("путь_к_папке_сохранения_который_вы_нашли")
```
Например:
```lua
